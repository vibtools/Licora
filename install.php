...
<div class="install-container">
    <div class="card shadow-sm installer-card">
        ...
        <div class="card-body p-4 p-md-5">
            ...
            <?php elseif ($step === 5): ?>
                <p>Licora will initialize <code>database.sql</code>, preserving the existing API v1/v2 schema and adding the scoped Admin License Control API tables introduced in v5.8.3.</p>
