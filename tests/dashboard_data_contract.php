...
foreach (['api_logs', 'v2_audit_logs', "'legacy_check_license_included' => false", 'expired_last_30_days', 'expiring_next_30_days'] as $marker) {
    $assert(strpos($model, $marker) !== false, 'dashboard data-source/expiration marker: ' . $marker);
}
