...
$publicLanding=(string)file_get_contents($root.'/index.php');
foreach(['Vib Tools [License]','Official license guide','How to use your license','Avoid license misuse','Contact Vib Tools','admin/login.php','https://vibtools.github.io/vibtools-brand-assets/logos/icon-512.png','support@vib.tools','hello@vib.tools','https://wa.me/8801795470603','https://github.com/vibtools','https://gitlab.com/vibtools','https://www.facebook.com/vib.tools','https://www.instagram.com/vib.tools/','https://www.tiktok.com/@vibtools','https://x.com/vibtools','https://www.reddit.com/user/VibTools/','5660 Kochakata'] as $marker){uc_ok(strpos($publicLanding,$marker)!==false,'public license landing marker missing '.$marker);}
uc_ok(stripos($publicLanding,'<style')===false,'public license landing must use shared component CSS');
uc_ok(strpos($publicLanding,'root-license-page')!==false,'public license landing scope missing');
