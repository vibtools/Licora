...
$pages=['index.php','license.php','device.php','logs.php','api_keys.php','client_apps.php','v2_devices.php','developer_guide.php','updates.php','settings.php','admins.php','audit.php','backup.php','health.php','about.php','login.php','logout.php'];
...
foreach(['index.php','license.php','device.php','logs.php','api_keys.php','client_apps.php','v2_devices.php','developer_guide.php','updates.php','settings.php','admins.php','audit.php','backup.php','health.php','about.php'] as $route){ur_ok(strpos($nav,"'file' => '{$route}'")!==false,'primary sidebar route missing '.$route);}
