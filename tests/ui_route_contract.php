...
$pages=['index.php','license.php','device.php','logs.php','api_keys.php','client_apps.php','v2_devices.php','updates.php','settings.php','admins.php','audit.php','backup.php','health.php','login.php','logout.php'];
...
foreach(['index.php','license.php','device.php','logs.php','api_keys.php','client_apps.php','v2_devices.php','updates.php','settings.php','admins.php'] as $route){ur_ok(strpos($nav,"'file' => '{$route}'")!==false,'primary sidebar route missing '.$route);}
$sidebar=(string)file_get_contents($root.'/admin/includes/ui/sidebar.php');
ur_ok(strpos($sidebar,'AdminHelpers::canDelete()')!==false,'existing Super Admin update visibility contract must be preserved');
