...
$assert(strpos($config, "define('APP_VERSION', '5.5.1')") !== false, 'generated configuration targets v5.5.1');
...
$assert(licora_installation_write_flag($tempRoot, '5.5.1'), 'installation flag written atomically');
...
$assert(($flag['version'] ?? '') === '5.5.1', 'installation flag records version');
