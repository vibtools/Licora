...
$assert(strpos($config, "define('APP_VERSION', '5.8.4')") !== false, 'generated configuration targets v5.8.4');
...
$assert(licora_installation_write_flag($tempRoot, '5.8.4'), 'installation flag written atomically');
...
$assert(($flag['version'] ?? '') === '5.8.4', 'installation flag records version');
