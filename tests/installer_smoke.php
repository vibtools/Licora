...
$assert(strpos($config, "define('APP_VERSION', '5.2.2')") !== false, 'generated configuration targets v5.2.2');
...
$assert(licora_installation_write_flag($tempRoot, '5.2.2'), 'installation flag written atomically');
...
$assert(($flag['version'] ?? '') === '5.2.2', 'installation flag records version');
