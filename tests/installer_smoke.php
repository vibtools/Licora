...
$assert(strpos($config, "define('APP_VERSION', '5.2.1')") !== false, 'generated configuration targets v5.2.1');
...
$assert(licora_installation_write_flag($tempRoot, '5.2.1'), 'installation flag written atomically');
...
$assert(($flag['version'] ?? '') === '5.2.1', 'installation flag records version');
