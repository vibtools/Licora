...
$assert(strpos($config, "define('APP_VERSION', '5.8.2')") !== false, 'generated configuration targets v5.8.2');
...
$assert(licora_installation_write_flag($tempRoot, '5.8.2'), 'installation flag written atomically');
...
$assert(($flag['version'] ?? '') === '5.8.2', 'installation flag records version');
