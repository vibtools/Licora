...
$assert(strpos($config, "define('APP_VERSION', '5.4.0')") !== false, 'generated configuration targets v5.4.0');
...
$assert(licora_installation_write_flag($tempRoot, '5.4.0'), 'installation flag written atomically');
...
$assert(($flag['version'] ?? '') === '5.4.0', 'installation flag records version');
